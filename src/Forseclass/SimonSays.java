...
public class SimonSays extends KeyAdapter {
 ...
 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
  	...
  	images.put(new Integer(KeyEvent.VK_RIGHT), "IMAGES2.jpg");
  	images.put(new Integer(KeyEvent.VK_DOWN), "imagrz3.jpg");
  	images.put(new Integer(KeyEvent.VK_LEFT), "imagres.jpg");
 // 3. Tell the user to "Press the matching key when 'Simon says' otherwise press a different key"
 JOptionPane.showMessageDialog(null, "PRess the matching simon says otherwise press a different key, HOT DAWGGGGGG");
...
timeAtStart = new Date();
	...
	public void keyPressed(KeyEvent e) {
    	...
    	//18.   if the keyCode doesn't match the imageIndex and "Simon didn't say..."  increase their score	
    		...
    		speak("You suck at this game i mean it is so easy, how did u get it wrong homie");
    	}
    	...
    	if(tries>10){
    		speak("SORRY U HAVE FINISHED THIS GAME, HOT DOG");
    		speak("YOU GOT "+ pointz +" POINTZ");
