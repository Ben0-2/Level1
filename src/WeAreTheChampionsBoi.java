...
public class WeAreTheChampionsBoi extends MouseAdapter {
...
for (int i = 0; i < 15; i++) {
	...
	String greeting = "Merry Christmas, you will never be as good as me. Sorry";
	...
	public static void main(String[] args) {
		new WeAreTheChampionsBoi();
	}

	TurtlePanel tortoiseWindow;

	WeAreTheChampionsBoi() {
